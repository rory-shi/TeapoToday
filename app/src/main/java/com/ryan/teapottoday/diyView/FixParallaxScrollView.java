...
/**
 * Created by rory9 on 2016/5/18.
 */
public class FixParallaxScrollView extends ScrollView implements AbsListView.OnScrollListener {
    ...
    public FixParallaxScrollView(Context context, AttributeSet attrs,
                             int defStyle) {
    ...
    public FixParallaxScrollView(Context context) {
        super(context);
        init(context);
    }
