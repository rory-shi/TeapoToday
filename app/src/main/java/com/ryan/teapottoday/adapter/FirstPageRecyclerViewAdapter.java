...
public class FirstPageRecyclerViewAdapter extends RecyclerView.Adapter<FirstPageRecyclerViewAdapter.ViewHolder> {
    ...
    public FirstPageRecyclerViewAdapter(Context context,ArrayList<Integer> myDataset) {
        mContext = context;
        mDataset = myDataset;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        ImageView ivPot = (ImageView) cvTop.findViewById(R.id.iv_in_cv);
        ...
        if (position==0) {
            ...
            ivPot.setImageResource(mDataset.get(position - 2));
